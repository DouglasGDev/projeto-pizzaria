...
export default function Order(){
    ...
    async function handleCloseOrder(){
        try {
            ...
            await api.delete('/order', { // função de deletar a mesa antes de fazer pedido que bate na requisição da api
                params:{
    ...
    async function handleAdd() {
        if (!productSelected) {
          return; // Verificar se productSelected é indefinido e retornar sem fazer nada
        }
    ...
    function handleFinishOrder() {
        navigation.navigate("FinishOrder", {
          ...
          order_id: route.params.order_id,
          price : price, // Adicione o preço total como um parâmetro
        })
      }
